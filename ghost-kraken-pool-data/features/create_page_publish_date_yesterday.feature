Feature: Creating a page in Ghost
  ...
  @user1 @web
  Scenario: As a Ghost user I want to create a Page with publishing date yesterday.
    ...
    Then I enter yesterday into input field contained in css selector ".gh-date-time-picker-date "
